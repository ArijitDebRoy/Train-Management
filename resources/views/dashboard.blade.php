   ...
   <div class="container" style="padding-top: 2vh">
       ...
       <div class="row" style="margin-top: 7vh">
           ...
           <div class="col-sm-3" >
               ...
               <label style="color: #d757f6;font-size: 55px;display: block">{{session('Tcount')}}</label>
           </div>
           <div class="col-sm-3">
               <button class="btn btn-default" style="background-color: white;border:5px solid #ff8a84;width: 150px;height: 150px"><i class="fa fa-bullhorn fa-5x" style="color: #ff8a84"></i></button>
                <label style="color: #ff8a84;font-size: 55px;display: block">{{session('Scount')}}</label>
           </div>
           <div class="col-sm-3">
               ...
               <label style="color: #72bb53;font-size: 55px;display: block">8</label>
           </div>
           <div class="col-sm-3">
